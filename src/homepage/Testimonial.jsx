  ...
  return (
    <section className="py-16 bg-green-600">
      <div className="container mx-auto px-5">
        <h5 className="text-white text-lg bg-green-400 p-2 text-center flex items-center justify-center mx-auto font-medium w-[150px] rounded-full">
        <PiStarFourFill />  Testimonial
        </h5>
        <h1 className="text-white text-3xl lg:text-4xl font-bold mt-2 text-center mb-10">
        ...
        >
          {testimonials.map((testimonial, index) => (
             <div
             key={index}
             className="bg-white rounded-lg shadow-lg p-6 mx-3 my-4 md:my-6 max-w-sm md:max-w-md lg:max-w-lg"
           >
             {/* Testimonial Description */}
             <p className="text-gray-600 mb-4 italic text-center md:text-left">
               {testimonial.description}
             </p>
             ...
             {/* Headline */}
             <h4 className="text-gray-800 font-semibold text-lg mb-2 text-center md:text-left">
